            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="h-48 bg-gradient-to-r from-green-500 to-teal-600 relative">
                    <div class="absolute bottom-0 left-0 p-6 w-full bg-gradient-to-t from-black/60 to-transparent">
                        ...
                        <p class="text-green-100 mt-1 flex items-center">
                            <i data-lucide="book" class="w-4 h-4 mr-2"></i>
                            {{ $lopHoc->monhoc->TenMonHoc ?? 'Môn học' }}
                        </p>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-800">{{ $lopHoc->ThoiLuong ?? 'N/A' }} phút/buổi</p>
                    </div>
                    <div>
                        <p class="text-gray-500 text-sm mb-1">Số buổi/tuần</p>
                        <p class="font-semibold text-gray-800">{{ $lopHoc->SoBuoiTuan ?? 'N/A' }} buổi</p>
                    </div>
                    @if($lopHoc->DiaChi)
                ...
                <div class="bg-blue-50 rounded-2xl border border-blue-200 p-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="text-blue-900 font-semibold">
                                ...
                                @elseif($yeuCau->TrangThai === 'ChapNhan')
                                    <span class="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-medium">Đã chấp nhận</span>
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="text-blue-900">{{ $yeuCau->NgayTao->format('d/m/Y H:i') }}</span>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                @php
                    $statusConfig = [
                        ...
                        'DangHoc' => ['text' => 'Đang dạy', 'class' => 'bg-green-100 text-green-800 border-green-200', 'icon' => 'book-open'],
                ...
                @if($lopHoc->TrangThai == 'DangHoc')
                    <div class="mt-4 space-y-2">
                        ...
                        <a href="{{ route('giasu.lophoc.schedule.add', $lopHoc->LopYeuCauID) }}" 
                           class="block w-full text-center py-3 rounded-xl bg-green-600 text-white font-bold hover:bg-green-700 transition-colors">
                    ...
                    @if($lopHoc->nguoihoc->taikhoan && $lopHoc->nguoihoc->taikhoan->SoDienThoai)
                        <div class="pt-4 border-t border-gray-100">
                            <a href="tel:{{ $lopHoc->nguoihoc->taikhoan->SoDienThoai }}" 
                               class="block w-full py-2.5 text-center text-sm font-semibold text-white bg-green-600 rounded-lg hover:bg-green-700 transition-colors">
