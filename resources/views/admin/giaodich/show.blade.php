            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-white 50">Loại giao dịch</label>
                            <p class="form-control-plaintext form-control-dark">
                                @php
                                    $typeColors = [
                                        'NapTien' => 'bg-success',
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-white 50">Số tiền</label>
                            <p class="form-control-plaintext form-control-dark">
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="form-label text-white 50">Thời gian</label>
                            <p class="form-control-plaintext form-control-dark">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    @if($giaodich->taiKhoan)
                        <div class="mb-3">
                            <label class="form-label text-white 50">ID Tài khoản</label>
                        ...
                        @endif
                    @else
                        <p class="text-white 50">Không có thông tin tài khoản</p>
                    @endif
                </div>
            </div>
        </div>
