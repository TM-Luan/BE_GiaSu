    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <label class="form-label text-muted">Trường đào tạo</label>
                ...
                <div class="col-12 mt-3">
                    <label class="form-label text-muted">Thành tích</label>
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    <label class="form-label text-muted">Ảnh đại diện</label>
                ...
                <div class="col-md-3 mb-3">
                    <label class="form-label text-muted">CCCD Mặt trước</label>
                ...
                <div class="col-md-3 mb-3">
                    <label class="form-label text-muted">CCCD Mặt sau</label>
                ...
                <div class="col-md-3 mb-3">
                    <label class="form-label text-muted">Ảnh Bằng cấp</label>
