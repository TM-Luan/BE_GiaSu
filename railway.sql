...
INSERT INTO `GiaSu` VALUES (1,2,'Nguyễn Văn A','Q.1, TP.HCM','Nam','1995-05-10','Cử nhân Sư phạm Toán','3 năm',NULL),(2,3,'Trần Thị B','Q.3, TP.HCM','Nữ','1996-08-22','Cử nhân Ngôn ngữ Anh','2 năm',NULL),(3,7,'Nguyễn Văn A',NULL,NULL,NULL,NULL,NULL,NULL),(4,8,'Tran Minh Luan',NULL,NULL,NULL,NULL,NULL,NULL);
